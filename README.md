...
> [!NOTE]  
> Keep using below `...yuzono/cursed-manga-repo...` URL, regardless where this actual GH repository is.
...
https://github.com/yuzono/cursed-manga-extensions/issues/new/choose
